    ...
    *,
    ...
    if missing != set():
        ...
        raise TypeError(
            ...
            The annotations are missing for the following parameters: {", ".join(missing_s)}""",
        )

    if f.__doc__ is None:
        raise TypeError(f"the function '{f.__name__}' Should have a descrition. ")
    ...
    function = ToolFunction(
        function=Function(description=description, name=fname, parameters=parameters),
    )
